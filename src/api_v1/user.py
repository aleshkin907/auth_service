...
from schemas.user_schema import IssuedJWTTokenSchema, LoginUserSchema, RegisterUserSchema, TokenInfoSchema, UpdateUserDataSchema
from services.token_service import TokenService
from services.user_service import UserService
from utils.auth import decode_jwt
from jwt_auth.validations import get_current_auth_payload_for_refresh
...
async def login_user(
    ...
    await jwt_token_service.create_or_update(token_schema)
...
async def refresh_token(
    ...
    user = await user_service.get_one(payload.get("sub"))
    pass
